...
import type { AgentResult, App, AppVersion, AppStats, ChatMessage, PageResult, RunResult } from './types'
...
export const appApi = {
  ...
  agentChat(
    ...
    return request.post<never, AgentResult>(`/apps/${appId}/agent/chat`, data)
  }
}
